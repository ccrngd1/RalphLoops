...
3. Invokes the planner persona in a dedicated Kiro CLI session whose
...
class Planner:
    """Wire the planner persona's Kiro CLI session to the task-creation pipeline."""
    ...
    async def bootstrap(
        ...
        *,
        ...
        # Run the Kiro CLI session under the reserved ``planner`` call
