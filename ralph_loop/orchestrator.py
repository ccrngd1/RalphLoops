...
Token usage reported by the Kiro CLI invocation is attached to the
...
def build_orchestrator_prompt(
    ...
    The returned string is handed verbatim to the Kiro CLI as the
...
class Orchestrator:
    ...
    async def select_persona(
        ...
        *,
        ...
        Token usage reported by the Kiro CLI invocation is attached to
        ...
        except KiroInvocationTimeout as e:
